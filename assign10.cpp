...
static vector<float> obstaclesMiddle = { 2.5, 7.5, 3.5, 7.5, 2.5, 8.5, 4.5, 10.5, 4.5, 9.5, 5.5, 9.5, 5.5, 8.5, 5.5, 7.5, 5.5, 6.5, 6.5, 6.5, 6.5, 8.5, 6.5, 9.5, 7.5, 8.5, 8.5, 8.5, 8.5, 9.5, 9.5, 9.5, 9.5, 8.5, 9.5, 7.5, 9.5, 6.5, 8.5, 6.5, 10.5, 9.5, 10.5, 10.5, 11.5, 7.5, 12.5, 7.5, 12.5, 8.5};
static vector<float> obstaclesBottom = { 2.5, 10.5, 2.5, 11.5, 2.5, 12.5, 3.5, 12.5, 5.5, 12.5, 6.5, 12.5, 6.5, 11.5, 8.5, 11.5, 8.5, 12.5, 9.5, 12.5, 11.5, 12.5, 12.5, 12.5, 12.5, 11.5, 12.5, 10.5};
...
void drawLaberynth(){
    ...
    for (int j = 0; j < obstaclesBottom.size(); j = j + 2){
        glPushMatrix();
        glTranslated(obstaclesBottom.at(j) * squareSize, obstaclesBottom.at(j+1) * squareSize, 0);
        glColor3f(0, 0, 0);
        glutWireCube(50);
        glColor3f(1, 1, 1);
        glutSolidCube(50);
    ...
    for (int k = 0; k < obstaclesMiddle.size(); k = k + 2){
        glPushMatrix();
        glTranslated(obstaclesMiddle.at(k) * squareSize, obstaclesMiddle.at(k+1) * squareSize, 0);
        glColor3f(0, 0, 0);
        glutWireCube(50);
        glColor3f(1, 1, 1);
        glutSolidCube(50);
...
void drawFood(float pacmanX, float pacmanY){
    ...
    for (int j = 0; j < food.size(); j = j + 2)
    {
        ...
        glTranslatef(food.at(j)*squareSize, food.at(j + 1)*squareSize, -1);
...
//        }
//    }
    glTranslated(positionX*squareSize, positionY*squareSize, 0);
    glScaled(1, 1, 2);
